            ...
            for message in messages:
                ...
                def _click_done() -> None:
                    try:
                        ...
                        # (base 1920x1080). Measured from a surveil capture: the
                        # orange Done button is centred at (960, 925) in the game
                        # frame. The previous (960, 886) landed ~39px high, in the
                        # gap above the button (on the emote row), so the click
                        # missed and the bot stalled on surveil.
                        base_point = (960, 925)
